...
import { IResetPasswordService, IResetPasswordValidator } from './resetpassword.interface';
import { IResetPassword } from '../../services/resetPassword/resetpassword.dto';
import { InvalidError } from '../../exceptions/invalid';
import { isMoreThanXHours } from '../../utils/date.helper';
import { IUserService } from '../user/user.interface';
import { OperationError } from '../../exceptions/operation';
